...
public class Course {
    ...
    /**
     * Purpose: It sets semester when the course was taken to the parameter string
    ...
    /**
     * It sets helpfulness score provided by student when posting review to parameter double
     * Post-conditions: the helpful variable is set to the parameter double
     * @param helpful
     */
    ...
    /**
     * It sets easiness of course provided by student when posting review to parameter double
     * Post-conditions: the easy variable is set to the parameter double
     * @param easy
     */
    ...
    /**
     * It sets clarity score provided by student when posting review to parameter double
     * Post-conditions: the clarity variable is set to the parameter double
     * @param clarity
     */
    ...
    /**
     * Purpose: It gets easiness score provided by student when posting 
     * review and returns the value
     * @return the easiness
     */
